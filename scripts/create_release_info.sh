...
(
  ...
  echo "##### Linux ARM"
  echo "\`\`\`"
  echo "implementation 'me.tytoo:jcef-natives-linux-arm:jcef-$jcef_commit+cef-$cef_version'"
  echo "\`\`\`"
  echo ""
  echo "##### Linux ARM64"
  echo "\`\`\`"
  ...
  echo "##### Windows i386"
  echo "\`\`\`"
  echo "implementation 'me.tytoo:jcef-natives-windows-i386:jcef-$jcef_commit+cef-$cef_version'"
  echo "\`\`\`"
  echo "</details>"
  echo ""
