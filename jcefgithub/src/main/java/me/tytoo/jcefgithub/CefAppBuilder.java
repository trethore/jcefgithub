package me.tytoo.jcefgithub;

import me.tytoo.jcefgithub.impl.progress.ConsoleProgressHandler;
import me.tytoo.jcefgithub.impl.step.check.CefInstallationChecker;
import me.tytoo.jcefgithub.impl.step.extract.TarGzExtractor;
import me.tytoo.jcefgithub.impl.step.fetch.PackageClasspathStreamer;
import me.tytoo.jcefgithub.impl.step.fetch.PackageDownloader;
import me.tytoo.jcefgithub.impl.step.init.CefInitializer;
import me.tytoo.jcefgithub.impl.util.FileUtils;
import me.tytoo.jcefgithub.impl.util.macos.UnquarantineUtil;
 ...
 * your needs. When done, call {@link me.tytoo.jcefgithub.CefAppBuilder#build()}
...
public class CefAppBuilder {
    ...
    public CefAppBuilder() {
        ...
        mirrors.add("https://maven.pkg.github.com/trethore/jcefgithub/me/tytoo/jcef-natives-{platform}/{tag}/jcef-natives-{platform}-{tag}.jar");
    }
