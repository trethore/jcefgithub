...
```Gradle
implementation 'io.github.trethore:jcefgithub:143.0.14.14'
```
...
```Gradle
implementation('io.github.trethore:jcefgithub:143.0.14.14:all-relocated') {
    transitive = false
}
```
