...
```Gradle
implementation 'io.github.trethore:jcefgithub:143.0.14.10'
```
...
```Gradle
implementation('io.github.trethore:jcefgithub:143.0.14.10:all-relocated') {
    transitive = false
}
```
