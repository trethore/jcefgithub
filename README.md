...
<h1>JCEF GITHUB</h1>
<a href="../../releases/latest"><img alt="build-all" src="../../actions/workflows/publish.yml/badge.svg"></img></a>
...
```Gradle
implementation 'io.github.trethore:jcefgithub:143.0.14.15'
```
...
```Gradle
implementation('io.github.trethore:jcefgithub:143.0.14.15:all-relocated') {
    transitive = false
}
```
...
This will only include the base jcef library in your project. Natives will be downloaded and extracted on first run. If you want to skip downloading and instead bundle the natives, include the native artifacts in your project dependencies. You can browse all published artifacts on [Maven Central](https://repo1.maven.org/maven2/io/github/trethore/). Native bundles are currently published for `linux-amd64`, `linux-arm64`, `windows-amd64`, `windows-arm64`, `macosx-amd64`, and `macosx-arm64`. It is recommended to only include one bundle per build though, as each bundle is ~100MB. If you wish to include them, make sure you export one build per platform!
