...
```Gradle
implementation 'io.github.trethore:jcefgithub:143.0.14.11'
```
...
```Gradle
implementation('io.github.trethore:jcefgithub:143.0.14.11:all-relocated') {
    transitive = false
}
```
