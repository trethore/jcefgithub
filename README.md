...
```Gradle
implementation 'io.github.trethore:jcefgithub:146.0.10.1'
```
...
```Gradle
implementation('io.github.trethore:jcefgithub:146.0.10.1:all-relocated') {
    transitive = false
}
```
