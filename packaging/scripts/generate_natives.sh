...
./../packaging/scripts/fill_template.sh ../packaging/templates/natives/README.txt README.txt

#Generate a build_meta file
./../packaging/scripts/fill_template.sh ../packaging/templates/natives/build_meta.json build_meta.json
...
mkdir compile
./../packaging/scripts/fill_template.sh ../packaging/templates/natives/pom.xml compile/pom.xml
cp -r ../packaging/templates/natives/src compile
./../packaging/scripts/fill_template.sh ../packaging/templates/natives/src/main/java/io/github/trethore/jcefgithub/CefNativeBundle.java compile/src/main/java/io/github/trethore/jcefgithub/CefNativeBundle.java
cd compile
...
zip -qr jcef-natives-$2-$3.jar jcef-natives-$2-$3.tar.gz io META-INF

#Generate a pom file
echo "Generating pom..."
./../packaging/scripts/fill_template.sh ../packaging/templates/natives/pom.xml jcef-natives-$2-$3.pom
