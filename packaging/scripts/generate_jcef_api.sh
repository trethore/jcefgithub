...
../../packaging/scripts/fill_template.sh ../../packaging/templates/api/README.txt README.txt
../../packaging/scripts/fill_template.sh ../../packaging/templates/api/build_meta.json build_meta.json
...
cd ..
echo "Generating pom..."
./../packaging/scripts/fill_template.sh ../packaging/templates/api/pom.xml jcef-api-$release_tag.pom
